    ...
    output = pd.DataFrame(
        {
            ...
            "entry_speed_kph_a": merged.get("entry_speed_kph_a"),
            "entry_speed_kph_b": merged.get("entry_speed_kph_b"),
            "apex_speed_kph_a": merged.get("apex_speed_kph_a"),
            "apex_speed_kph_b": merged.get("apex_speed_kph_b"),
            "exit_speed_kph_a": merged.get("exit_speed_kph_a"),
            "exit_speed_kph_b": merged.get("exit_speed_kph_b"),
            "min_speed_kph_a": merged.get("min_speed_kph_a"),
            "min_speed_kph_b": merged.get("min_speed_kph_b"),
