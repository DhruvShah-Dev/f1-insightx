...
REVOKE SELECT ON race_pick_scores FROM anon, authenticated;
REVOKE SELECT ON race_pick_overall_scores FROM anon, authenticated;
GRANT SELECT ON race_pick_scores TO service_role;
GRANT SELECT ON race_pick_overall_scores TO service_role;
